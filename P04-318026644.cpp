...
int main()
{
	...
	*/
	...
	//CABINA 
		...
		model = glm::translate(model, glm::vec3(0.50f, 2.5f, 0.0f));
		...
		model = glm::translate(model, glm::vec3(0.150f, 2.5f, 0.0f));
		...
		model = glm::translate(model, glm::vec3(0.50f, 0.8f, 0.0f));
		modelaux = model;
		...
		//BASE
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::translate(model, glm::vec3(4.50f, -13.0f, 0.0f));
		model = glm::scale(model, glm::vec3(11.0f, 4.0f, 3.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		//meshList[0]->RenderMesh(); //dibuja cubo y pirámide triangular
		...
		model = glm::translate(model, glm::vec3(-15.0f, -1.0f, 8.5f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion5()), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.250f, 1.250f, 1.250f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::translate(model, glm::vec3(-15.50f, -1.2f, 0.50f));
		...
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::translate(model, glm::vec3(-15.0f, 1.5f, 8.5f));
