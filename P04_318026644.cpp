...
int main()
{
	...
	*/
	...
	//ESFERA CABEZA
		...
		model = glm::scale(model, glm::vec3(1.20f, 1.20f, 1.20f));
	...
	//CILINDRO
		...
		model = glm::scale(model, glm::vec3(1.50f, 3.0f, 1.50f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
	...
	//PATA 1
		...
		//ARTICULACION 1
		model = glm::translate(model, glm::vec3(-1.2f, -1.0f, -4.7f));
		...
		model = modelaux;
		//PATA 1.1
		model = glm::translate(model, glm::vec3(-1.40f, 0.9f, .05f));
		model = glm::rotate(model, glm::radians(145.0f), glm::vec3(0.0f, 0.0f, 1.0f));
	
		modelaux = model;
		model = glm::scale(model, glm::vec3(3.0f, .20f, .20f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f,0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMesh(); //dibuja cubo y pirámide triangular
		...
		model = glm::translate(model, glm::vec3(1.50f, 0.0f, .05f));
		model = glm::rotate(model, glm::radians(145.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		//PATA 1.2
		model = glm::translate(model, glm::vec3(1.10f, -.90f, .04f));
		...
		model = modelaux;
			//CONO PARA LA PARTE INFERIOR

		model = glm::translate(model, glm::vec3(1.70f, -.03f, .06f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));

		modelaux = model;
		model = glm::scale(model, glm::vec3(.20f, 1.50f, .20f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
...
//PATA 2
		...
		//PATA 2.1
		model = glm::translate(model, glm::vec3(1.10f, 0.9f, .05f));
		...
		//PATA 2.2
		model = glm::translate(model, glm::vec3(-.90f, -1.0f, 0.05f));
		model = glm::rotate(model, glm::radians(45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		model = glm::translate(model, glm::vec3(-1.50f, 0.0f, 0.05f));
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
...
//PATA 3
		...
		//ARTICULACION 5
		model = glm::translate(model, glm::vec3(1.2f, -1.0f, -3.3f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion5()), glm::vec3(0.0f, 1.0f, 0.0f));
		modelaux = model;
		//dibujar una pequeña esfera
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.25f));
		...
		//PATA 3.1
		model = glm::translate(model, glm::vec3(1.10f, 1.0f, 0.1f));
		model = glm::rotate(model, glm::radians(45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		model = glm::translate(model, glm::vec3(1.50f, 0.0f, .1f));
		model = glm::rotate(model, glm::radians(45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		//PATA 3.2
		model = glm::translate(model, glm::vec3(-.90f, -1.0f, 0.0f));
		...
		model = glm::translate(model, glm::vec3(-1.50f, 0.0f, 0.1f));
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
	...
	//PATA 4
		...
		//ARTICULACION 1
		model = glm::translate(model, glm::vec3(-1.2f, -1.0f, -3.2f));
		...
		model = glm::rotate(model, glm::radians(37.50f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::translate(model, glm::vec3(1.4f, 0.0f, -.02f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(3.0f, .20f, .20f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		...
		model = glm::translate(model, glm::vec3(1.40f, 0.0f, -0.02f));
		model = glm::rotate(model, glm::radians(37.50f), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		//PATA 4.2
		model = glm::translate(model, glm::vec3(.50f, 1.2f, .03f));
		...
		model = glm::translate(model, glm::vec3(-1.20f, 0.0f, .04f));
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		//OREJA 1
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-1.0f, 2.50f, -4.0f));
		...
		model = glm::translate(model, glm::vec3(0.0f, -0.50f, -0.50f));
		model = glm::rotate(model, glm::radians(230.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(12.0f), glm::vec3(0.0f, 0.0f, 1.0f));

		modelaux = model;
		model = glm::scale(model, glm::vec3(.10f, 1.0f, .10f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[3]->RenderMeshGeometry();
